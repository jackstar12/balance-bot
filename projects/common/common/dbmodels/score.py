...
if TYPE_CHECKING:
    from common.dbmodels.balance import Balance as BalanceDB
    from common.models.balance import Amount as AmountModel
from common.dbsync import Base, BaseMixin
